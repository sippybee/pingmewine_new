...
twilio_account_sid = os.getenv('ACf9deebb2ba3ac128c92a4da25828a472')
twilio_auth_token = os.getenv('1d20fa53a0f4bc61d721f00ee9facd05')
twilio_number = os.getenv('+13527479463')
